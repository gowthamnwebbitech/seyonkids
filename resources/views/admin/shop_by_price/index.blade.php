...
@section('admin')
    ...
    <div class="card-header">
        <h4 class="card-title">Shop By Price List</h4>
        <button type="button" class="btn btn-primary" onclick="window.location.href = '{{ route('by.price.create') }}'">
            Add New
        </button>
                ...
                <tbody>
                    @foreach ($shop_by_price as $data)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('by.price.edit', $data->id) }}" class="btn btn-success btn-xs me-2">
                                        <i class="fas fa-pencil-alt"></i>
                                    </a>
                                    <a href="{{ route('by.price.delete', $data->id) }}" class="btn btn-danger btn-xs">
