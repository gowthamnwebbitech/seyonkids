...
@section('admin')
    ...
    <div class="card-header">
        ...
        <button type="button" class="btn btn-primary"
            onclick="window.location.href = '{{ route('admin.product.submenu.add') }}'">
            Add New
        </button>
    </div>
                ...
                <tbody>
                    @foreach ($submenu as $key => $item)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('admin.product.submenu.edit', $item->id) }}"
                                        class="btn btn-success btn-xs me-2">
                                        <i class="fas fa-pencil-alt"></i>
                                    </a>
                                    <a href="{{ route('product.submenu.delete', $item->id) }}"
