                ...
                <tbody>
                    @foreach ($product as $key => $item)
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>
                                <img src="{{ asset($item->product_img) }}" style="width:60px" alt="Product Image">
                                {{ $item->product_name }}
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('product.edit', $item->id) }}" class="btn btn-success btn-xs me-2">
                                        <i class="fas fa-pencil-alt"></i>
                                    </a>
                                    <a href="{{ route('product.delete', $item->id) }}" class="btn btn-danger btn-xs">
